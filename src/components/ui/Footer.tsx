          ...
          {[
            {
              ...
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 grayscale opacity-80 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            },
            {
              ...
              iconColor: "group-hover:text-white",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 grayscale opacity-80 transition-all duration-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a
              ...
              className={`p-2.5 rounded-2xl border border-[#1a1a1a] bg-[#0a0a0a] shadow-sm group transition-all duration-300 ${hoverBg} ${iconColor} flex items-center justify-center`}
              aria-label={label}
            >
