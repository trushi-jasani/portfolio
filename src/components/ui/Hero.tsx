        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              {[
                {
                  ...
                  label: "GitHub",
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:text-[#181717] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                },
                {
                  ...
                  label: "LinkedIn",
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:text-[#0a66c2] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                },
                {
                  ...
                  label: "Email",
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:text-[#ea4335] transition-all duration-300" viewBox="0 0 20 20" fill="currentColor">
                ...
                },
                {
                  ...
                  label: "Discord",
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:text-[#5865F2] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a
                  ...
                  className="p-2.5 rounded-full border border-zinc-200 hover:border-zinc-300 dark:border-zinc-800 dark:hover:border-zinc-600 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md group transition-all duration-300"
                  aria-label={label}
                >
                  {icon}
                </a>
          ...
          >
            <div className="relative">
              ...
              {/* Photo frame */}
              <div className="relative w-80 h-96 rounded-2xl overflow-hidden bg-zinc-50 border border-zinc-200 shadow-xl">
                <Image
              ...
              {/* Floating badge */}
              <div className="absolute bottom-10 -left-12 glass rounded-2xl px-6 py-3 shadow-xl border border-white/80 whitespace-nowrap z-20 flex flex-col items-start animate-float-slow">
