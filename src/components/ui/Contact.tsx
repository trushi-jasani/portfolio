          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full bg-rose-500 text-white text-sm font-medium hover:bg-rose-600 transition-all shadow-md hover:shadow-rose-200/60"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full border border-zinc-200 text-zinc-700 text-sm font-medium hover:border-zinc-400 hover:text-zinc-900 transition-all"
              >
